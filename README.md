...
- **Frontend**: This repository contains the React frontend
- **Backend**: Hosted separately at `https://deepfakebackend.vercel.app/`
- **Backend Repository**: [Deepfake Backend Repo](https://github.com/your-username/deepfake-backend)
...
**Backend Repository**: [Link to Backend Repo](https://github.com/owesh74/deepfakeflask.git)
...
- **Frontend**: This repository contains the React frontend
- **Backend**: Hosted separately at `https://deep-fake-detector-owesh74s-projects.vercel.app/`
- **Backend Repository**: [Deepfake Backend Repo](https://github.com/owesh74/deepfakeflask.git)
